...
model {
    ...
    // Random initialization of Sigma using an inverse-Wishart prior
    for(g in 1:G){
        Sigma[g] ~ inv_wishart(n_visit + 2, diag_matrix(rep_vector(1.0, n_visit)));
    }
